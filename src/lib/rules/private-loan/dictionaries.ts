...
export const privateLoanFactDictionary = {
...
export const privateLoanDerivedSignalDictionary = {
  writing_complete: "存在明确书面借贷材料",
  writing_partial: "仅有部分书面材料",
...
export const privateLoanTagDictionary = {
...
export const privateLoanConflictMatrix: Record<PrivateLoanRuleSlot, PrivateLoanConflictStrategy> = {
